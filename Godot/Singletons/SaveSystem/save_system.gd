...
const default_inventory_item_resource : Resource = preload("res://Assets/Resources/InventoryItemResources/Default Resource (DO NOT EDIT)/inventory_item_properties.tres")
...
func create_new_item(name:String, description:String, node:Node3D) -> void:
	...
	var resource : Resource = default_inventory_item_resource.duplicate()
	resource.name = name
