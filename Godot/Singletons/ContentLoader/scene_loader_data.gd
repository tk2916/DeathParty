...
var target_scene_enum : Globals.SCENES
...
func set_teleport_point() -> void:
	...
	print("Setting teleport point for ", scene.name)
	var target_scene : LoadableScene = ContentLoader.get_scene(target_scene_enum)
...
func save_properties() -> void:
	...
	target_scene_enum = loader.target_scene
	if loader.popup:
